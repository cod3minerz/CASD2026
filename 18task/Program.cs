...
public class MyTreeMap<K, V> where K : IComparable<K>  
{
    ...
    private void SubMap(Node node, K start, K end, List<KeyValuePair<K, V>> result)
    {
        ...
        if (cmpStart > 0) 
        {
            SubMap(node.Left, start, end, result);
        }
        if (cmpEnd < 0)   
        {
            SubMap(node.Right, start, end, result);
        }
    }
...
public class Program
{
    public static void Main()
    {
        ...
        Console.WriteLine("\nGet value for key 10: " + map.Get(10));  // Выведет: apple
        
        Console.WriteLine("\nContains key 5: " + map.ContainsKey(5));  // Выведет: True
        
        Console.WriteLine("\nContains value 'cherry': " + map.ContainsValue("cherry"));  // Выведет: True
        
        Console.WriteLine("\nFirst key: " + map.FirstKey());  // Выведет: 5
        Console.WriteLine("Last key: " + map.LastKey());    // Выведет: 15
        ...
        // Получаем подмножество элементов с ключами в диапазоне от 5 до 12 
        ...
        Console.WriteLine("\nAfter removing key 10:");
        Console.WriteLine("First key: " + map.FirstKey());  // Выведет: 5
        Console.WriteLine("Last key: " + map.LastKey());    // Выведет: 15
        
        Console.WriteLine("\nSize of map: " + map.Size());  // Выведет: 3
    }
}